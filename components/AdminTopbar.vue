    ...
    <div class="top-bar">
        ...
        <ClientOnly>
            <div class="right-content">
                ...
                <!-- Use the drop component for auto handling of dropdowns. -->
                <!-- It will handle toggling and click outside events out of the box -->
                <!-- They have to be a child of the <btn> component to work  -->
