<template>
    <div class="chart-box">
        <btn class="chart-tooltip">
            ...
            <tooltip>
                <h4>Users by Page</h4>
                The <strong>Views per Page</strong> chart is a bar chart that visualizes the number
                of users visiting each specific page on your website. Each bar represents a single
                page, and the length of the bar corresponds to how many users have visited that page
