    ...
    <div class="chart-box">
        <btn class="chart-tooltip">
            ...
            <tooltip>
                ...
                The <strong>Average Session Duration</strong> chart measures the average amount of
                time users spend on your website during a single session. A session is defined as a
                period of user interaction with your site, which can include multiple page views,
