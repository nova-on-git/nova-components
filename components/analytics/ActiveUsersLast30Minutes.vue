    ...
    <div class="chart-box">
        <btn class="chart-tooltip">
            ...
            <tooltip>
                ...
                The <strong>Real-Time Active Users</strong> chart shows the number of users
                currently active on your website in the last 30 minutes. This chart provides a
                snapshot of user engagement in real-time, allowing you to monitor live traffic and
                see how users interact with your site at any given moment.
            </tooltip>
        </btn>
