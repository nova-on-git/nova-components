    ...
    <div class="chart-box">
        <btn class="chart-tooltip">
            ...
            <tooltip>
                ...
                <strong> Bounce Rate </strong>in Google Analytics refers to the percentage of
                single-page sessions, where users visit a page on your website and leave without
                interacting with any other pages or taking any further actions (such as clicking on
                a link, filling out a form, or making a purchase).
            </tooltip>
        </btn>
