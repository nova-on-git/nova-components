<template>
    <div class="chart-box">
        <btn class="chart-tooltip">
            ...
            <tooltip>
                <h4>Users By Date</h4>
                The <strong>Users by Date</strong> chart is a line graph that tracks the number of
                users who visited your website over a specified period. This chart helps you
                visualize traffic trends over time, enabling you to identify patterns in user
